export const bookTips: Record<string, string[]> = {
  ...
  'Success Mindsets': [
    ...
    'Shift from a prevention mindset to a promotion mindset: prevention thinkers focus on avoiding failure and threats; promotion thinkers focus on achieving goals and possibilities. Reframe every challenge as "what can I gain here?" rather than "what could go wrong?"',
    'Practise growth mindset language daily: replace "I\'m not good at this" with "I\'m not good at this yet." Replace "I failed" with "I learned what doesn\'t work." The language you use about your abilities literally shapes the neural pathways that govern your effort.',
    'Develop an outward mindset by seeing others as people, not obstacles: an inward mindset treats others as vehicles for your goals. An outward mindset asks: what are their needs, objectives, and challenges? How can I make their work easier? This single shift transforms leadership and relationships.',
    'Use mindset triggers to catch yourself in the moment: identify the situations where your worst mindsets emerge (criticism, competition, high stakes) and prepare a specific mental cue — a word, a breath, a question — that interrupts the automatic reaction and gives you a half-second to choose a better response.',
    'Build psychological safety in every team you lead: people default to their worst mindsets (closed, fixed, prevention, inward) when they feel threatened. As a leader, your primary job is to reduce threat and create the conditions where people can bring their best mindsets to work.',
    'Align your mindsets with your stated values: most people believe they have good values but act from poor mindsets. The gap between what you say you value and how you actually behave is almost always a mindset problem, not a values problem. Close the gap by working on the mindset, not just repeating the value.',
    'Use the "mindset ladder" for gradual change: you cannot jump from a fixed to a growth mindset overnight. Gottfredson recommends identifying the next rung — a slightly more open or growth-oriented belief — and practising that specific belief until it becomes automatic before moving further.',
    'Measure your mindset progress through behavioural evidence, not feelings: you will not feel your mindset changing — you will see it in your behaviour. Track concrete actions: Did I ask for feedback this week? Did I pursue a stretch goal? Did I consider a colleague\'s perspective before reacting? Behaviour is the only reliable signal of real mindset change.',
  ],
